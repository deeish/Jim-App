...
async function main() {
    ...
    const response = await groq.chat.completions.create({
        ...
        messages: [
            {
                role: 'system',
                content: 'You are a certified fitness trainer. Respond with exactly one JSON object: { "name": "string", "day": "string", "exercises": [ { "name": "string", "sets": number, "reps": number, "weight?" : number, "notes?": "string" } ] }. No markdown.',
            },
            {
                role: 'user',
                content: 'Generate a short upper body workout for Monday, 4 exercises, intermediate level, about 45 minutes.',
            },
        ],
...
//# sourceMappingURL=test-groq-generate.js.map