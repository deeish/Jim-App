...
export const SLOTS_BY_FOCUS: Record<string, SlotDefinition[]> = {
  ...
  lower: [
    ...
    {
      role: 'accessory_1',
      description: 'Leg isolation, or a split squat, lunge or step-up',
      min: 1,
      max: 1,
    },
    {
      role: 'accessory_2',
      description: 'Calves, or glute work (hip thrust, bridge, abduction)',
      min: 1,
      max: 1,
    },
    {
      role: 'finisher',
      description: 'Optional core or a loaded carry',
      min: 0,
      max: 1,
    },
  ],
