...
- **Endurance: probably backwards for the people who pick it.** Someone who picks Endurance is usually a runner or cyclist wanting strength support. Their lifting rows here are 12 to 25 reps at 30 to 45 seconds rest, 2 to 4 sets, which is more cardio. The endurance-sport literature finds heavy and explosive strength work improves running economy and performance, not high-rep lifting: Rønnestad and Mujika 2014 (heavy or explosive strength for runners, heavy for cyclists) and Blagrove, Howatson and Hayes 2018, with a 2023 meta-analysis adding that high-load and combined methods improve economy while submaximal lifting does not. Confirmed on the final check.
...
4. **"Build" progression is boxed in by the cap.** Week one is capped at the average of the duration window (30 to 45 minutes gives about 12 sets). Later weeks multiply sets by 1.08 to 1.24 and are re-clamped against the top of the window (about 15 sets at 45 minutes). So a range builds only within the range, and a fixed duration cannot build at all because both caps are the same number. Rep drops of 1 to 3 per week on a 4-6 main lift land at 3-5 and stop. Corrected on the final check: the first draft said the volume never builds, which is only true for fixed durations.
...
- Rønnestad & Mujika 2014, strength training for running and cycling endurance: https://pubmed.ncbi.nlm.nih.gov/23914932/ ; Blagrove, Howatson & Hayes 2018, strength training and distance running (Sports Medicine); 2023 meta-analysis on running economy by method: https://link.springer.com/article/10.1007/s40279-023-01978-y
