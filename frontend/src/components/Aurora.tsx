...
/**
 * Animated Skia aurora backdrop. On native it renders directly; on web it is
 * lazy-loaded after CanvasKit is ready (with the gradient fallback meanwhile).
 */
export default function Aurora({ colors }: { colors: ColorPalette }) {
  ...
  // Require lazily so web never eagerly evaluates the Skia component module.
  const AuroraBackground = require('./AuroraBackground').default;
